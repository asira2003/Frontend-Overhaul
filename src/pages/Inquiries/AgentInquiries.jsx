...
import {
  searchAgentInquiries,
  approveAgentrInquiry,
  declineAgentInquiry,
  invoiceAgentInquiry,
} from "../../api/Inquiries/AgentInquiries";
...
export async function loader({ request }) {
  ...
  const searchBy = url.searchParams.get("searchBy") || "agentTourInquiryId";
  ...
  const agentInquiriesDataAPI = await searchAgentInquiries(
    searchBy,
    searchValue,
    page,
    sortType,
  ...
  const agentInquiriesData = { authentication, agentInquiriesDataAPI };
  return defer(agentInquiriesData);
}
...
export async function action({ request }) {
  ...
  if (formType === "declineInquiry") {
    const agentTourInquiryId = formData.get("agentTourInquiryId");
    const batchNo = formData.get("batchNo");
    if (agentTourInquiryId === null || agentTourInquiryId === "") {
      return null;
    }
    if (batchNo === null || batchNo === "") {
      return null;
    }
    let declineAgentInquiryResponse = await declineAgentInquiry(
      agentTourInquiryId,
      batchNo
    );
    if (declineAgentInquiryResponse !== null) {
      declineAgentInquiryResponse = {
        ...declineAgentInquiryResponse,
        formType: formType,
      };
      return declineAgentInquiryResponse;
    }
  }
  ...
  if (formType === "approveInquiry") {
    ...
    let approveAgentInquiryResponse = await approveAgentrInquiry(
      agentTourInquiryId,
      batchNo
    );
    if (approveAgentInquiryResponse !== null) {
      approveAgentInquiryResponse = {
        ...approveAgentInquiryResponse,
        formType: formType,
      };
      return approveAgentInquiryResponse;
    }
  }
  ...
  if (formType === "invoiceInquiry") {
    ...
    if (response.errors.length !== 0) {
      ...
      let addAgentInvoiceResponse = await invoiceAgentInquiry(
        agentTourInquiryId,
        batchNo,
        agentTourInvoiceTitle,
        agentTourInvoiceDescription,
...
export default function AgentInquiries() {
  const { agentInquiriesDataAPI, authentication } = useLoaderData();
  const [searchParams, setSearchParams] = useSearchParams();
  const response = useActionData();
  const navigation = useNavigation();
  const [searchForm, setSearchForm] = useState({});
  const searchFormSubmitRef = useRef(null);
  const agentTourInquiryIdRef = useRef(null);
  ...
  useEffect(() => {
    setSearchForm(() => {
      return {
        searchBy: searchParams.get("searchBy") || "agentTourInquiryId",
      ...
      <Suspense fallback={<ContentThrobber />}>
        <Await resolve={authentication}>
          {({ message }) => {
            ...
            return (
              <>
                <Await resolve={agentInquiriesDataAPI}>
                  {({ data }) => {
                    const { pagination, objects, tourPackages } = data;
                    const datagrid = objects.map((tourInquiry) => {
                      return (
                        <tr key={tourInquiry.agentTourInquiryId}>
                          <td className="text-truncate">
                            {tourInquiry.agentTourInquiryId}
                          </td>
                          <td className="text-truncate">
                            {tourInquiry.agentTourInquiryDate}
                          </td>
                          <td className="text-truncate">
                            {tourInquiry.agent.agentName}
                          </td>
                            ...
                            <div className="row">
                              <div className="col col-3">
                                <button
                                  ...
                                  value={tourInquiry.agentTourInquiryId}
                                  onClick={() =>
                                    loadModalData(
                                      tourInquiry.agentTourInquiryId
                                    )
                              ...
                              <div className="col col-3">
                                <button
                                  type="button"
                                  id={`${tourInquiry.agentTourInquiryId}`}
                                  className="action-btn delete-btn"
                                  title="Invoice"
                                  data-bs-toggle="modal"
                    ...
                    useEffect(() => {
                      ...
                      if (
                        ...
                        if (
                          ...
                          agentTourInquiryIdRef.current =
                            modal.agentTourInquiryId;
                          setLoading(() => true);
                        }
                      }
                    ...
                    useEffect(() => {
                      if (agentTourInquiryIdRef.current !== null) {
                        loadModalData(agentTourInquiryIdRef.current);
                        setTimeout(function () {
                          document.getElementById("approveModalClose").click();
                          document
                            .getElementById(agentTourInquiryIdRef.current)
                            .click();
                          agentTourInquiryIdRef.current = null;
                          setLoading(() => false);
                        }, 500);
                      }
                    }, [agentInquiriesDataAPI]);
                    ...
                    function loadModalData(agentTourInquiryId) {
                      const tourInquiry = objects.filter(
                        (tourInquiry) =>
                          tourInquiry.agentTourInquiryId === agentTourInquiryId
                      )[0];
                      ...
                      setModal(() => {
                        return {
                          ...
                          agentTourInvoice: tourInquiry.agentTourInvoice,
                          agent: {
                            agentId: tourInquiry.agent.agentId,
                            agentName: tourInquiry.agent.agentName,
                            agentPhone: tourInquiry.agent.agentPhone,
                          },
                          ...
                          agentTourInquiryId: tourInquiry.agentTourInquiryId,
                          agentTourInquiryDate:
                            tourInquiry.agentTourInquiryDate,
                          ...
                          agentTourInvoiceTitle: tourInquiry.tourPackageTitle,
                          agentTourInvoiceDescription:
                            tourInquiry.tourPackageDescription,
                          agentTourInvoicePricing: "",
                          items: [],
                              ...
                              <div className="row pt-3 mb-3 align-items-center user-content">
                                <div className="col title-grn">
                                  <h4 className="page-header user-heading">
                                    Agent Tour Inquiries Management
                                  </h4>
                                </div>
                              </div>
                                ...
                                <div className="col col-xxl-3">
                                  <div className="row align-items-center">
                                    ...
                                    <div className="col col-sm-4 search-by-col-2">
                                      ...
                                      >
                                        <option value="agentTourInquiryId">
                                          Tour&nbsp;Inquiry&nbsp;ID
                                        </option>
                              ...
                              <div className="modal-header align-items-start">
                                <div>
                                  <h4 className="page-header">
                                    Agent Tour Inquiries Management | View
                                  </h4>
                          ...
                          <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                            <div className="modal-content">
                              <div className="modal-header align-items-start">
                                <div>
                                  <h4 className="page-header">
                                    Agent Tour Inquiries Management | Approve
                                    Inquiry
                                  </h4>
                                  <div className="mt-4 callback-text">
                                    <span className="fw-bold">
                              ...
                              <div className="modal-footer">
                                <div className="col text-end add-btn pe-2">
                                  <Form method="post">
                                    ...
                                    <input
                                      type="hidden"
                                      name="agentTourInquiryId"
                                      value={modal.agentTourInquiryId}
                                      readOnly={true}
                                    />
                                    <input
                                      type="hidden"
                          ...
                          <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                            <div className="modal-content">
                              <div className="modal-header align-items-start">
                                <div>
                                  <h4 className="page-header">
                                    Agent Tour Inquiries Management | Decline
                                    Inquiry
                                  </h4>
                                  <div className="mt-4 callback-text">
                                    <span className="fw-bold">
                          ...
                          <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                            <div className="modal-content">
                              <div className="modal-header align-items-start">
                                <div>
                                  <h4 className="page-header">
                                    Agent Tour Inquiries Management | Invoice
                                    Inquiry
                                  </h4>
                                  <div className="mt-4 callback-text">
                                    <span className="fw-bold">
                          ...
                          <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                            <div className="modal-content">
                              <div className="modal-header align-items-start">
                                <div>
                                  <h4 className="page-header">
                                    Agent Tour Inquiries Management | Add Tour
                                    Item
                                  </h4>
                                </div>
                                <button
                          ...
                          <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                            <div className="modal-content">
                              <div className="modal-header align-items-start">
                                <div>
                                  <h4 className="page-header">
                                    Agent Tour Inquiries Management | Edit Tour
                                    Item
                                  </h4>
                                </div>
                                <button
